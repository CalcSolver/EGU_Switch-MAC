...
-External Gaming Unit is a folder that lets you play external games, hence the name, you can connect it up to your computer and control your computer from your nintendo switch
 ...
 - laptop or device with a terminal
 # Download:
 https://github.com/CalcSolver/EGU_Switch/releases/
 
 
 # INTRUCTIONS FOR MACS/APPLE DEVICES'S WITH TERMINAL
1. Download the lastest update of the folder
2. Open Mac/Apple Terminal
3. Copy the cloudgaming folder into Terminal and type cd then paste the folder
4. Copy the .command file content and paste it
5. Open the setup.command then the run.command
6. Type node server.js into the Terminal
